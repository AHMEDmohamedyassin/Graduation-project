...
const TableComp = () => {
    ...
    useEffect(() => {
        if(result.selected_member){
            ...
            if(
                `${safe}${max_top_stress}${min_top_stress}${max_bottom_stress}${min_bottom_stress}${max_shear}`
                !== `${section.safe}${section.max_top_stress}${section.min_top_stress}${section.max_bottom_stress}${section.min_bottom_stress}${section.max_shear}`
            )
                setSection(prev => ({...prev , safe , max_top_stress , min_top_stress , max_bottom_stress , min_bottom_stress , max_shear}))
        }


    } , [result.selected_member , section])
